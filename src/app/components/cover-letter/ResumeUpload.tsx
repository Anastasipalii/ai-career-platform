  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-slate-400 mb-5 leading-relaxed">
        ...
        create a more personalized cover letter.
      </p>

      {/* Drop zone */}
      <label
        htmlFor="resume-upload"
        className="relative flex flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed cursor-pointer transition-all duration-200 py-10 px-6"
        style={{
        ...
        {fileName ? (
          <>
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-slate-500 mt-0.5">File uploaded — AI will use this to personalize your letter</p>
            </div>
            <button
              type="button"
          ...
          <>
            ...
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#64748b" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M7.5 10V2M4 5l3.5-3.5L11 5" />
