...
export default function CareerPathUpload({ fileName, onFileChange }: CareerPathUploadProps) {
      ...
      >
        {fileName ? (
          <>
            ...
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#f9a8d4" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">AI will use this to personalise your roadmap</p>
            </div>
            <button
              type="button"
          ...
          <>
            <div
              ...
              style={{
                background: dragging ? "rgba(236,72,153,0.14)" : "rgba(255,255,255,0.04)",
                border: dragging ? "1px solid rgba(236,72,153,0.35)" : "1px solid rgba(255,255,255,0.1)",
              }}
            >
              <svg
                width="22" height="22" viewBox="0 0 24 24" fill="none"
                stroke={dragging ? "#f9a8d4" : "#64748b"}
            ...
            <div>
              <p className="text-sm font-medium text-slate-300 mb-1">
                ...
                <span style={{ color: dragging ? "#f9a8d4" : "#a78bfa" }} className="transition-colors duration-200">
                  browse files
                </span>
              </p>
