      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            <a href="/login" className="text-sm text-slate-400 hover:text-white transition-colors px-4 py-2">
              Sign in
            </a>
            <a
              href="/signup"
        ...
        <div className="md:hidden border-t border-white/[0.06]"
          ...
          <div className="px-4 py-4 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2 pt-2 border-t border-white/[0.06]">
              <a href="/login" className="text-sm text-slate-400 hover:text-white transition-colors py-2">Sign in</a>
              <a
                href="/signup"
