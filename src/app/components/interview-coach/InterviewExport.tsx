...
export default function InterviewExport({ hasFeedback }: InterviewExportProps) {
    ...
    >
      ...
      <div className="flex flex-col gap-2.5">
        ...
        <button
          ...
          style={{
            ...
            boxShadow: hasFeedback ? "0 0 24px rgba(217,119,6,0.3)" : "none",
          }}
        >
      ...
      {!hasFeedback && (
        <p className="text-xs text-slate-600 text-center mt-3">
          Complete a practice answer to enable export
        </p>
      )}
    </div>
  );
