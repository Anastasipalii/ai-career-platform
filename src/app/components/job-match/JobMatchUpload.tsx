...
export default function JobMatchUpload({ fileName, onFileChange }: JobMatchUploadProps) {
  ...
  return (
    <div
      ...
      style={{
        ...
        borderColor: dragging ? "rgba(139,92,246,0.5)" : "rgba(255,255,255,0.07)",
        boxShadow: dragging ? "0 0 32px rgba(139,92,246,0.12)" : "none",
      }}
    >
      ...
      <p className="text-sm text-slate-400 mb-5 leading-relaxed">
        AI will analyse your experience, skills, and achievements to find and
        rank the best matching job opportunities.
      </p>
      ...
      <label
        ...
        style={{
          borderColor: dragging ? "rgba(139,92,246,0.6)" : "rgba(255,255,255,0.1)",
        ...
        {fileName ? (
          <>
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">AI will use this for personalised matching</p>
            </div>
            <button
              type="button"
          ...
          <>
            <div
              ...
              style={{
                background: dragging ? "rgba(139,92,246,0.14)" : "rgba(255,255,255,0.04)",
                border: dragging ? "1px solid rgba(139,92,246,0.35)" : "1px solid rgba(255,255,255,0.1)",
              }}
            >
              <svg
                width="22" height="22" viewBox="0 0 24 24" fill="none"
                stroke={dragging ? "#c4b5fd" : "#64748b"}
            ...
            <div>
              <p className="text-sm font-medium text-slate-300 mb-1">
                ...
                <span style={{ color: dragging ? "#c4b5fd" : "#a78bfa" }} className="transition-colors duration-200">
                  browse files
                </span>
              </p>
