...
export default function LinkedInResumeUpload() {
    ...
    >
      <div className="flex items-center gap-2.5 mb-3">
        ...
        <span
          ...
          style={{ background: "rgba(10,102,194,0.12)", color: "#93c5fd", border: "1px solid rgba(10,102,194,0.25)" }}
        >
          Optional
        </span>
      </div>
      ...
      <p className="text-sm text-slate-400 mb-5 leading-relaxed">
        Upload your resume so AI can extract your experience, skills, and achievements to
        ...
        {fileName ? (
          <>
            <div
              ...
              style={{ background: "rgba(10,102,194,0.12)", border: "1px solid rgba(10,102,194,0.28)" }}
            >
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Ready — AI will use this to personalise your profile</p>
            </div>
            <button
              type="button"
          ...
          <>
            <div
              ...
              style={{
                background: dragging ? "rgba(10,102,194,0.14)" : "rgba(255,255,255,0.04)",
                border: dragging ? "1px solid rgba(10,102,194,0.35)" : "1px solid rgba(255,255,255,0.1)",
              }}
            >
              <svg
                width="22" height="22" viewBox="0 0 24 24" fill="none"
                stroke={dragging ? "#93c5fd" : "#64748b"}
            ...
            <div>
              <p className="text-sm font-medium text-slate-300 mb-1">
                ...
                <span style={{ color: dragging ? "#93c5fd" : "#a78bfa" }} className="transition-colors duration-200">
                  browse files
                </span>
              </p>
