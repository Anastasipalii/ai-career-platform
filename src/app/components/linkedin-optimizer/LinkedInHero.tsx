  ...
  return (
    <section className="relative overflow-hidden grid-bg py-24">
      ...
      <div
        ...
        style={{ background: "radial-gradient(ellipse, rgba(10,102,194,0.14) 0%, transparent 65%)" }}
      />
      <div
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border mb-7"
          style={{ borderColor: "rgba(10,102,194,0.35)", background: "rgba(10,102,194,0.1)" }}>
        ...
        <p className="text-lg text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
          Improve your LinkedIn headline, summary, and experience sections with
          AI-powered copy that attracts recruiters — available in 16+ languages with
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          {[
            ...
            { value: "7",     label: "Tone styles" },
            { value: "< 1min", label: "Optimization time" },
          ].map((s, i, arr) => (
