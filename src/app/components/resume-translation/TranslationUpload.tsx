...
export default function TranslationUpload({ fileName, onFileChange }: TranslationUploadProps) {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-slate-400 mb-5 leading-relaxed">
        Upload your resume and choose the language you want to translate it into.
        AI preserves your layout, formatting, and ATS structure throughout.
      </p>
        ...
        {fileName ? (
          <>
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Ready to translate</p>
            </div>
            <button
              type="button"
          ...
          <>
            <div
              ...
              style={{
                background: dragging ? "rgba(16,185,129,0.14)" : "rgba(255,255,255,0.04)",
                border: dragging ? "1px solid rgba(16,185,129,0.35)" : "1px solid rgba(255,255,255,0.1)",
              }}
            >
              <svg
                width="22" height="22" viewBox="0 0 24 24" fill="none"
                stroke={dragging ? "#34d399" : "#64748b"}
            ...
            <div>
              <p className="text-sm font-medium text-slate-300 mb-1">
                ...
                <span style={{ color: dragging ? "#6ee7b7" : "#a78bfa" }} className="transition-colors duration-200">
                  browse files
                </span>
              </p>
